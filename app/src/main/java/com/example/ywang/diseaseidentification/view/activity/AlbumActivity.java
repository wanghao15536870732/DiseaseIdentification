...
public class AlbumActivity extends AppCompatActivity {
    ...
    private void initData(){
        ...
        Item item1 = new Item("http://img01.tooopen.com/Downs/images/2011/7/14/sy_20110714110422194316.jpg","2020-05-12",
                "这天的天气不错",latLng,"晴朗","14° - 28°","太原","尖草坪区","中北大学主楼");
        mList.add(item1);

        LatLng latLng1 = new LatLng(38.013872,112.468427);
        Item item2 = new Item("http://img01.tooopen.com/Downs/images/2011/8/8/sy_20110808173542492016.jpg","2020-05-06",
        ...
        Item item4 = new Item("http://pic.nipic.com/2008-01-19/2008119124120703_2.jpg","2020-04-27",
                "终于快结出葡萄了，看起来也没有啥病，挺健康的",latLng3,"晴朗","6° - 22°","太原","上兰村","太原市清徐县东青堆南街 东青堆培忠葡萄采摘大棚");
        mList.add(item4);


        LatLng latLng4 = new LatLng(38.4,112.8);
        Item item5 = new Item("http://www.haonongzi.com/pic/news/20170110094219630.jpg","2020-04-25",
                "到了给农作物打药的季节了，虽然下了点小雨，不过不影响",latLng4,"晴朗","6° - 22°","小雨","尖草坪区","");
        mList.add(item5);

        LatLng latLng5 = new LatLng(38.4,112.8);
        Item item6 = new Item("http://img67.nongjx.com/9/20170520/636308751422414322128.jpg","2020-04-22",
                "现在发展的真快，已经开始用上无人机打药了，真方便！",latLng5,"晴朗","8° - 22°","太原","尖草坪区","");
        mList.add(item6);

        LatLng latLng6 = new LatLng(38.4,112.8);
        Item item7 = new Item("http://www.guoshu.cn/file/upload/201707/31/1052247524750.jpg","2020-04-18",
